...
O system prompt da ASA (buildSystemPrompt em artifacts/api-server/src/routes/asa.ts) DEVE conter a data de hoje. Sem isso, o modelo escolhe um ano padrão (observado: 2025) ao interpretar "dia 3 de junho" e grava as datas nesse ano errado. As entradas existem no banco mas não aparecem na tabela do ano corrente (ex.: folgas da Amanda gravadas em 2025-06-* enquanto a UI mostrava Junho/2026).
