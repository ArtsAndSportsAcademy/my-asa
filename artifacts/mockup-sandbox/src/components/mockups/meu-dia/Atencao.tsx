  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-4 py-3 flex flex-col gap-3">
        {/* Card Próxima Atividade — inalterado, calmo */}
        ...
        {/* Card IA — narrativa ajustada para atenção */}
        <div
        ...
        >
          <div className="flex items-start gap-2.5">
            ...
            <p className="text-[13px] text-gray-500 italic leading-relaxed flex-1">
              Tudo OK para o show de hoje. Atenção: você tem 2 itens que precisam de ação antes de amanhã.
            </p>
          </div>
          <button
        ...
        <div>
          <p className="text-[10px] font-semibold tracking-widest uppercase mb-2 px-1" style={{ color: "#FF9800" }}>
            Requer sua atenção
          </p>

          {/* Card atenção 1 — Entrega */}
          <div
            className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 mb-2"
            style={{ borderLeft: "4px solid #FF9800" }}
          >
            <div className="flex items-start gap-2.5">
              <AlertTriangle size={16} className="flex-shrink-0 mt-0.5" style={{ color: "#FF9800" }} />
              <div className="flex-1">
                <p className="text-[14px] font-semibold text-gray-900">Entrega — Relatório Técnico</p>
                <p className="text-[12px] text-gray-500 mt-0.5">Prazo: amanhã às 12:00</p>
                <p className="text-[12px] text-gray-400">Status: aguardando envio</p>
              </div>
              <button
          ...
          >
            <div className="flex items-start gap-2.5">
              <AlertTriangle size={16} className="flex-shrink-0 mt-0.5" style={{ color: "#FF9800" }} />
              <div className="flex-1">
                <p className="text-[14px] font-semibold text-gray-900">Folga 25/06 — sem resposta</p>
                <p className="text-[12px] text-gray-500 mt-0.5">Solicitada há 3 dias</p>
                <p className="text-[12px] text-gray-400">Impacto em: 2 dias</p>
              </div>
              <button
                className="text-[12px] font-medium flex-shrink-0"
                style={{ color: "#FF9800" }}
