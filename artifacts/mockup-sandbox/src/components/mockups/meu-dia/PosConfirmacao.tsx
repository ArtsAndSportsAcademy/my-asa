...
export function PosConfirmacao() {
  return (
    <div
    ...
    >
      ...
      {/* Toast de confirmação — aparece abaixo da status bar, some em 2s */}
      <div
      ...
      >
        ...
        <p className="text-white text-[14px] font-semibold">Alteração confirmada</p>
      </div>

      {/* Header — de volta ao normal, sem badge de urgência */}
      <div className="bg-white px-5 pt-3 pb-4 flex-shrink-0">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-3 flex flex-col gap-3">
        {/* Card Próxima Atividade — principal agora, sem label "atualizada" */}
        ...
        >
          <div className="flex items-start gap-2.5">
            ...
            <p className="text-[13px] text-gray-500 italic leading-relaxed flex-1">
              Alteração confirmada. Você vai como Marcos no Musical das 14h. Tudo alinhado para o show.
            </p>
          </div>
          <button
        ...
        {/* Linha do Tempo — volta à posição normal */}
        <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
          <p className="text-[10px] font-semibold text-gray-400 tracking-widest uppercase mb-3">
            Hoje — 2 Atividades
          </p>
        ...
        {/* Espaço em branco — estado voltou ao normal */}
