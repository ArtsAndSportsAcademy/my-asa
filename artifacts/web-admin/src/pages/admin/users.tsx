...
export default function UsersPage() {
  ...
  const handleEdit = () => {
    ...
    updateMutation.mutate(
      { id: editUser.id, data: { name: name.trim() || undefined, email: email.trim() || undefined } },
      {
        onSuccess: () => {
                      ...
                      <TableCell>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem onClick={() => { setEditUser(user); setEditForm({ name: user.name, email: user.email }); }}>
